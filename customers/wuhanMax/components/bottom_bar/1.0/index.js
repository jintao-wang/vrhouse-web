...
import FloorSwitch from '../../../../../components/floorSwitch/1.0';
...
const BottomBar = ({
  ...
  const [groupTwoState, setGroupTwoState] = useState(false);
  const [groupTwoIndex, setGroupTwoIndex] = useState(-1);
    ...
    <ContainerSC>
      ...
      <TopContainerSC>
        ...
        <ProjectGroupBar
          ...
          groupList={GroupMap.get(GroupInfo[0])}
          group={group}
        ...
        {/* groupTwo */}
        <ProjectGroupBar
          visible={groupTwoState}
          iconPosition={iconPosition[2]}
          groupList={GroupMap.get(GroupInfo[1])}
          group={group}
          onChange={handlePackageChange}
      ...
      <MainMenuSC allRadius>
        ...
        >
          <div>
            <IcoMoon iconSet={iconSet} icon="projectView" size={20}/>
          </div>
          <div className="describe">外景切换</div>
        </IconSC>
        {/* <IconSC */}
        {/*  styleSC={style} */}
        {/*  active={activeMenu === 1} */}
        ...
        {/* > */}
        {/*  <div> */}
        {/*    <IcoMoon iconSet={iconSet} icon="projectModel" /> */}
        {/*  </div> */}
        ...
        <IconSC
          ...
          styleSC={style}
          active={activeMenu === 2}
          onClick={() => handleGroupTwoClick(!groupTwoState)}
        >
          <div>
            <IcoMoon iconSet={iconSet} icon="sampleRoom" size={20}/>
          </div>
          <div className="describe">内景切换</div>
        </IconSC>
        <IconSC
        ...
        >
          <div>
            <IcoMoon iconSet={iconSet} icon="more" size={20}/>
          </div>
